...
5. XOR R10, R1, R4	- Performs bitwise XOR between R1 and R4, stores in R10	   32'h0040c533	             32'h0240c500
6. SLT R1, R2, R4	 - Sets R1 to 1 if R2 < R4, else sets to 0                  32'h0045a0b3	             32'h02415580
7. ADDI R12, R4, 5	- Adds immediate value 5 to R4, stores result in R12	      32'h004120b3	             32'h00520600
8. BEQ R0, R0, 15	 - Branches to offset 15 if R0 equals R0	                   32'h00000f63	             32'h00f00002
9. SW R3, R1, 2	   - Stores word from R3 to memory address (R1 + 2)	          32'h0030a123              32'h00209181
10. LW R13, R1, 2	 -  Loads word from memory address (R1 + 2) into R13	       32'h0020a6          	     32'h00208681
11. SRL R16, R14, R2 -  Shifts R14 right by the value in R2, stores in R16    32'h003023          	     32'h00271803
12. SLL R15, R1, R2	 - Shifts R1 left by the value in R2, stores in R15	      32'h0097b3	               32'h00208783
